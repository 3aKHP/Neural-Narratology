...
| **L4-B** | Fetish Specialization | 75–92 | Specialized fetish territory. **Not fixed by this protocol.** The specific content domain must be derived from the character's Variant Axes and Boundary Conditions. If the source material cannot support a derivable high-intensity domain, mark it as a gap for the user to supply — never fall back to any preset default. R-18 territory. |
