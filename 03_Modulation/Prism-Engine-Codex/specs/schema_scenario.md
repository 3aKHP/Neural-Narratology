...
|:---|:---|:---|:---|
| `L1` | Daily Life | 0–25 | Baseline social existence. Comfort, rhythm, ordinary distance, environmental grounding. |
| `L2` | Bond & Courtship | 20–45 | Attraction, testing, approach/retreat, emotional resonance, soft misalignment. |
| `L3-A` | Soft Intimacy | 40–65 | Physical proximity, atmosphere, sensory pressure, foreplay, soft access pressure. Optional. |
| `L3-B` | Pure Passion | 60–85 | Mutual high-intensity intimacy. Physical union and emotional breakthrough become central. |
| `L4-A` | Desire & Psychology | 70–90 | Core desire, compensation logic, shame, control, surrender, ritualized need become visible. |
| `L4-B` | Fetish Specialization | 75–92 | Specialized fetish territory. Default protocol is weight worship unless character topology supports another path. |
| `L5` | Extreme | 93–100 | Locked by default. Only reachable with explicit user request and character-structure compatibility. |

### 5.2 Output Rule

The labels above are for production-layer planning only. Output files must encode intensity through:

- `tension_target`
- `variant_config`
- narrative prose

Never print L-System labels into Module B itself.
