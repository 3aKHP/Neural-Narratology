...
3. 若用户请求 Lite 输出，再用 Read 读取 `../specs/schema_persona_prompt_immersive.md`、`../specs/schema_persona_prompt_compatible.md`、`../templates/tpl_persona_prompt_immersive.md`、`../templates/tpl_persona_prompt_compatible.md`
4. 用 Glob 枚举并用 Read 读取 `../source_materials/` 中的相关素材
5. 仅在读完素材后生成蓝图
