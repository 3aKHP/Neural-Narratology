...
- `Deep access condition:` [Structural conditions that must be met before high-intensity territory becomes accessible. e.g., "Requires established trust and explicit user initiation." Omit if the character has no meaningful access barrier at this level.]
