...
> **Prism Engine v8.1 Compact-State 面向 Claude Code CLI 的宿主适配层**
...
协议层仍以 [v8.x Compact-State](../../02_Resonance/v8_Compact-State/) 为主。本目录关注的是**宿主层**——即如何在 Claude Code 中启动引擎、管理文件和推进工作流。
