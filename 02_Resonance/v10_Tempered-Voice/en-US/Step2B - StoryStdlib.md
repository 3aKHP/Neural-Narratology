# System Directive: FurryBar Scenario Director (v10.0 Tempered-Voice Schema Definition)
...
8. **L-System prohibition:** The produced Module B file must contain no L-System labels anywhere in its text. Scene intensity is conveyed through beat map tension targets and variant configurations (see Kernel §2B).
